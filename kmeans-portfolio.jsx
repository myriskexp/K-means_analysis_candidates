...
const content = {
  en: {
    ...
    hero: {
      ...
      title: "Candidate Segmentation Analysis",
      description:
    ...
    appendix: {
      ...
      notes: [
        "This analysis was originally conducted for a multinational workforce solutions company. All client names, logos, and identifying references have been removed for portfolio use.",
        "The full analysis report (PDF) and the Python notebook (.ipynb) were anonymized and are available as reproducible artifacts upon request.",
  ...
  es: {
    ...
    appendix: {
      ...
      notes: [
        "Este análisis fue realizado originalmente para una empresa multinacional de soluciones de fuerza laboral. Todos los nombres de clientes, logos y referencias identificables fueron eliminados para uso de portafolio.",
        "El informe completo de análisis (PDF) y el cuaderno Python (.ipynb) fueron anonimizados y están disponibles como artefactos reproducibles bajo solicitud.",
  ...
  return (
    ...
    >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div
              style={{
                ...
                height: 32,
                borderRadius: 6,
                background: `linear-gradient(135deg, ${palette.accent}, ${palette.navy})`,
                display: "flex",
                alignItems: "center",
            ...
            {navItems.map(([key, id]) => (
              <button
                ...
                onMouseLeave={(e) => {
                  ...
                  e.target.style.color = palette.mid;
                }}
              >
                {t.nav[key]}
              </button>
      ...
      <section id="summary" style={sectionStyle()}>
        ...
        <p style={{ fontSize: 16, lineHeight: 1.7, color: palette.mid, marginBottom: 32, maxWidth: 800 }}>
          {t.summary.intro}
        </p>
      ...
      <section id="data" style={sectionStyle()}>
        ...
        <p style={{ fontSize: 15, lineHeight: 1.7, color: palette.mid, marginBottom: 28, maxWidth: 780 }}>
      ...
      <section id="method" style={{ background: palette.white }}>
        <div style={sectionStyle()}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.7, color: palette.mid, marginBottom: 36, maxWidth: 780 }}>
            {t.method.intro}
          </p>
          ...
          {t.findings.clusters.map((cl) => (
            ...
            >
              {cl.riskFlag && (
                ...
                >
                  ⚠ {lang === "en" ? "Risk Flag" : "Señal de Riesgo"}
                </span>
              )}
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                ...
                <div>
                  ...
                  <span style={{ fontSize: 13, color: palette.slate }}>
                    {cl.pct} · {cl.count} {lang === "en" ? "candidates" : "candidatos"}
                  </span>
                </div>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 16, fontSize: 13 }}>
                {[
                  [lang === "en" ? "Avg. Age" : "Edad Prom.", cl.avgAge],
                  [lang === "en" ? "Education" : "Educación", cl.education],
                  [lang === "en" ? "Gender" : "Género", cl.gender],
                  [lang === "en" ? "Experience" : "Experiencia", cl.experience],
                  [lang === "en" ? "Search Behavior" : "Comportamiento", cl.searchBehavior],
                ].map(([label, val], i) => (
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 16 }}>
            <div
              style={{
                ...
                height: 28,
                borderRadius: 6,
                background: `linear-gradient(135deg, ${palette.accent}, #60A5FA)`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                color: "#fff",
            ...
            <span style={{ fontWeight: 700, fontSize: 15, color: "#fff" }}>MyRiskExp</span>
          </div>
